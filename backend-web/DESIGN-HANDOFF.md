# 45ec9caa-4f1d-44e8-baa5-3b5b5d106048 implementation handoff

This archive is the source of truth for turning the design into production code. Start from `mes-graphite-dark.html`, then preserve the visual system, responsive behavior, and interactions found in the exported files.
...
## Source map
- Primary entry: `mes-graphite-dark.html`
...
- A single self-contained `mes-graphite-dark.html` is acceptable only when the export truly contains one user-facing screen and its CSS/JS are structured enough to extract tokens, components, states, and behavior.
...
1. Open `mes-graphite-dark.html` and `DESIGN-MANIFEST.json`; identify every screen file, launcher/overview file, app module, and interaction before coding.
...
## Entry points
- `mes-graphite-dark.html`
- `smart-factory-mes-wireframe.html`
...
1. Inspect `mes-graphite-dark.html` and `DESIGN-MANIFEST.json` first and identify reusable components before coding.
